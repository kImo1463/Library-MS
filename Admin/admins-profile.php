...
<div class="container mt-4" style="height: 700px;">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="username" class="col-sm-3 col-form-label" style="font-weight: bold; font-size: 1.2rem;">Password:</label>
                <div class="form-control" readonly>
                    <?php echo "<strong>" . $_SESSION["password"] . "</strong>"; ?>
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="phone-number" class="col-sm-3 col-form-label" style="font-weight: bold; font-size: 1.2rem;">Phone Number:</label>
                <div class="form-control" readonly>
